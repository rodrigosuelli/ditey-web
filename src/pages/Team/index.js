    ...
    <div className="team-container">
      ...
      <div className="cards">
        ...
        <div className="card three">
          ...
          <p>
            Apaixonado por tecnologia e programação. Focando na stack
            Javascript.
          </p>
          <div className="links">
            <a
      ...
      <div className="team-description">
        <img src={TeamPageImg} alt="studyingVector" />
        <div className="team-text">
          <h1>Uma Equipe Completa</h1>
          <h2>
            Somos do Ditey, um grupo de pessoas incríveis, comprometidas em dar
            o seu máximo para entregar um bom produto para o cliente.
          </h2>
        </div>
      </div>
    </div>
