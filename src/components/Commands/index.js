    ...
    return(
        <div className="commands-container">
            <div className="mic-container">
                <button onClick={handleHear} className={micClassName}>
            ...
            <div className="command-list">
                ...
                <div className="table-items">
                    <p className="table-item"><FaPlay className="action-icon" color="#757575"/>iniciar</p>        
                    <p className="table-item"><FaPause className="action-icon" color="#757575"/>pausar</p> 
                    <p className="table-item"><FaCheck className="action-icon" color="#757575"/>retomar</p>    
                    <p className="table-item"><FaStop className="action-icon" color="#757575"/>parar</p>    
                </div>
            </div>
        </div>
    );
